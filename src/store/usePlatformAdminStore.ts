...
const seedTenants: Tenant[] = [
  {
    id: 'bld-001', name: 'Sunny Acres Condominium',
    ...
    features: { fiscalLens: true, caseOps: true, complianceRunbook: true, aiAdvisor: true, documentVault: true, paymentProcessing: true },
  },
  {
    id: 'bld-002', name: 'Park View Towers',
  ...
  {
    id: 'bld-003', name: 'Georgetown Gardens HOA',
    ...
    features: { fiscalLens: true, caseOps: true, complianceRunbook: true, aiAdvisor: false, documentVault: false, paymentProcessing: false },
  },
  {
    id: 'bld-004', name: 'Capitol Hill Residences',
  ...
  {
    id: 'bld-005', name: 'Dupont Circle Condos',
