...
export const seedUnits: Unit[] = [
  {number:'101',owner:'Sarah Johnson',email:'sarah.j@example.com',phone:'202-555-0101',monthlyFee:450,votingPct:2.1,status:'ACTIVE',balance:0,moveIn:'2019-06-15',sqft:850,bedrooms:1,parking:'P-101',payments:[{date:'2026-01-05',amount:450,method:'ACH',note:''},{date:'2026-02-03',amount:450,method:'ACH',note:''}],lateFees:[],specialAssessments:[]},
  {number:'102',owner:'Mike Davis',email:'mike.d@example.com',phone:'202-555-0102',monthlyFee:475,votingPct:2.2,status:'ACTIVE',balance:0,moveIn:'2020-03-01',sqft:900,bedrooms:1,parking:'P-102',payments:[{date:'2026-01-04',amount:475,method:'check',note:'#4521'},{date:'2026-02-02',amount:475,method:'check',note:'#4589'}],lateFees:[],specialAssessments:[]},
  {number:'103',owner:'Vacant',email:'',phone:'',monthlyFee:450,votingPct:2.1,status:'ACTIVE',balance:0,moveIn:null,sqft:850,bedrooms:1,parking:'P-103',payments:[],lateFees:[],specialAssessments:[]},
  {number:'201',owner:'Lisa Chen',email:'lisa.c@example.com',phone:'202-555-0201',monthlyFee:500,votingPct:2.3,status:'ACTIVE',balance:0,moveIn:'2018-09-01',sqft:1050,bedrooms:2,parking:'P-201',payments:[{date:'2026-01-03',amount:500,method:'ACH',note:''},{date:'2026-02-01',amount:500,method:'ACH',note:''}],lateFees:[],specialAssessments:[]},
  {number:'202',owner:'Tom Wilson',email:'tom.w@example.com',phone:'202-555-0202',monthlyFee:450,votingPct:2.1,status:'ACTIVE',balance:0,moveIn:'2021-01-15',sqft:850,bedrooms:1,parking:null,payments:[{date:'2026-01-06',amount:450,method:'ACH',note:''},{date:'2026-02-05',amount:450,method:'ACH',note:''}],lateFees:[],specialAssessments:[]},
  {number:'203',owner:'Emma Stone',email:'emma.s@example.com',phone:'202-555-0203',monthlyFee:475,votingPct:2.2,status:'ACTIVE',balance:450,moveIn:'2022-07-01',sqft:900,bedrooms:1,parking:'P-203',payments:[{date:'2026-01-08',amount:475,method:'check',note:'#1891'}],lateFees:[],specialAssessments:[]},
  {number:'301',owner:'John Smith (You)',email:'john@example.com',phone:'202-555-0301',monthlyFee:450,votingPct:2.1,status:'ACTIVE',balance:925,moveIn:'2017-04-01',sqft:850,bedrooms:1,parking:'P-301',payments:[],lateFees:[{date:'2026-02-06',amount:25,reason:'Late payment — Jan 2026',waived:false}],specialAssessments:[{id:'sa-1',date:'2026-01-15',amount:500,reason:'Roof emergency repair assessment',paid:false,paidDate:null}]},
  {number:'302',owner:'Rachel Green',email:'rachel.g@example.com',phone:'202-555-0302',monthlyFee:450,votingPct:2.1,status:'ACTIVE',balance:0,moveIn:'2023-11-01',sqft:850,bedrooms:1,parking:null,payments:[{date:'2026-01-01',amount:450,method:'ACH',note:''},{date:'2026-02-01',amount:450,method:'ACH',note:''}],lateFees:[],specialAssessments:[]},
  {number:'303',owner:'David Park',email:'david.p@example.com',phone:'202-555-0303',monthlyFee:475,votingPct:2.2,status:'ACTIVE',balance:450,moveIn:'2020-08-15',sqft:900,bedrooms:1,parking:'P-303',payments:[{date:'2026-01-10',amount:475,method:'check',note:'#7823'}],lateFees:[],specialAssessments:[]},
  {number:'401',owner:'Amy Lee',email:'amy.l@example.com',phone:'202-555-0401',monthlyFee:500,votingPct:2.3,status:'ACTIVE',balance:0,moveIn:'2019-02-01',sqft:1050,bedrooms:2,parking:'P-401',payments:[{date:'2026-01-02',amount:500,method:'ACH',note:''},{date:'2026-02-01',amount:500,method:'ACH',note:''}],lateFees:[],specialAssessments:[]},
  {number:'402',owner:'James Brown',email:'james.b@example.com',phone:'202-555-0402',monthlyFee:450,votingPct:2.1,status:'ACTIVE',balance:0,moveIn:'2021-05-01',sqft:850,bedrooms:1,parking:null,payments:[{date:'2026-01-05',amount:450,method:'ACH',note:''},{date:'2026-02-04',amount:450,method:'ACH',note:''}],lateFees:[],specialAssessments:[]},
  {number:'403',owner:'Maria Garcia',email:'maria.g@example.com',phone:'202-555-0403',monthlyFee:475,votingPct:2.2,status:'ACTIVE',balance:1200,moveIn:'2018-11-15',sqft:900,bedrooms:1,parking:'P-403',payments:[],lateFees:[{date:'2026-01-06',amount:25,reason:'Late payment — Dec 2025',waived:false},{date:'2026-02-06',amount:50,reason:'Late payment — Jan 2026 (2nd offense)',waived:false}],specialAssessments:[{id:'sa-2',date:'2026-01-15',amount:500,reason:'Roof emergency repair assessment',paid:false,paidDate:null}]},
  {number:'501',owner:'Chris Taylor',email:'chris.t@example.com',phone:'202-555-0501',monthlyFee:500,votingPct:2.3,status:'ACTIVE',balance:0,moveIn:'2022-01-01',sqft:1200,bedrooms:2,parking:'P-501',payments:[{date:'2026-01-03',amount:500,method:'ACH',note:''},{date:'2026-02-02',amount:500,method:'ACH',note:''}],lateFees:[],specialAssessments:[]},
  {number:'502',owner:'Nicole White',email:'nicole.w@example.com',phone:'202-555-0502',monthlyFee:550,votingPct:2.5,status:'ACTIVE',balance:550,moveIn:'2023-06-01',sqft:1350,bedrooms:3,parking:'P-502A, P-502B',payments:[{date:'2026-01-07',amount:550,method:'check',note:'#9901'}],lateFees:[],specialAssessments:[]},
];
