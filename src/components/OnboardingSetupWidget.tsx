    ...
    <div className="mb-5">
      ...
      >
        <div className="flex items-center gap-4 px-5 py-3">
          {/* Icon */}
          <div className="w-8 h-8 rounded-lg bg-white bg-opacity-20 flex items-center justify-center shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px] text-amber-100">{completedSubTasks}/{totalSubTasks} tasks complete · {firstActive ? firstActive.config.title : 'All done'}</p>
          </div>

          {/* Progress ring */}
          <div className="shrink-0 relative w-10 h-10">
            <svg className="w-10 h-10 -rotate-90" viewBox="0 0 36 36">
              <circle cx="18" cy="18" r="15.5" fill="none" stroke="white" strokeOpacity="0.25" strokeWidth="3" />
          ...
          <svg className={`w-4 h-4 text-amber-200 transition-transform duration-200 shrink-0 ${expanded ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="px-5 pb-3">
          <div className="w-full h-1 bg-white bg-opacity-25 rounded-full overflow-hidden">
            <div
